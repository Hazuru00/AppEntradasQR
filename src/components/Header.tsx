    ...
    <header className="sticky top-0 z-40 w-full bg-[#181922] border-b-2 border-b-[#0a0b0e] border-t-2 border-t-[#4a4d61] shadow-md">
      <div className="max-w-4xl mx-auto px-4 h-14 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-2 group">
          <div className="w-7 h-7 rounded bg-[#2b2d3a] border-t border-l border-t-[#6b6f8a] border-l-[#6b6f8a] border-b border-r border-b-[#0a0b0e] border-r-[#0a0b0e] flex items-center justify-center text-[#e9e1d4]">
            <Disc className="w-4 h-4 group-hover:animate-spin" />
          </div>
          <div>
            <div className="flex items-center gap-1.5">
              <span className="font-bold tracking-tight text-white text-sm uppercase">
                {event.title}.EXE
              </span>
              <span className="text-[10px] font-mono px-1.5 py-0.2 bg-[#3b5998] text-white rounded-none border border-[#728ec7]">
                v2000
              </span>
            </div>
            <span className="text-[10px] text-[#8f92a8] font-mono block leading-none">
